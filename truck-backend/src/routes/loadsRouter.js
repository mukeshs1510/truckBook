...
router.get('/fortruck', authMiddleware, isShipperMiddleware, loadController.getLoadsTruck);
router.get('/assignedTruck/:id', authMiddleware, isShipperMiddleware, loadController.getTruckAssigned);
router.post('/fortruck', authMiddleware, isShipperMiddleware, truckAssignController.assignTruck);
